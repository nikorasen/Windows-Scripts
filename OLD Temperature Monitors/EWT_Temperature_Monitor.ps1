...
function Send_Report {
    ...
    $Body = "The Device: $env:computername at $txtDeviceLoc has surpassed the established temperature threshold of 80 degrees Celsius at $txtEventTime"
    ...
    $smtpclient.send($addrMailFrom, $addrMailTo, $txtMsgSub, $Body)
    }
