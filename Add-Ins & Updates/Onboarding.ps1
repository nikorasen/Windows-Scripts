#Elsewhen Technology Onboarding Script
#Author: Nic "Rant" Colon
#Version 1.0.0.1
#Last Review Date: 08/17/2020
#The following script should be run anytime a new client is onboarded or a new device is being setup for Elsewhen technology. It accomplishes the following;
#Allows scripts to run, Sets Timezone, Time-Server, Enables Network discovery and dependent services and starts network discovery, disables google update to remove google bloatware
...
net start w32time
w32tm /resync
#Starts Network Discovery Dependencies
...
#Removes Bloatware and Teams, Disables Cortana
...
#Teams is Tricksy, Requires its own script\
#Removes teams
...
#Stops Edge from taking over PDFs
...
#Get the Windows update module
Install-Module -Name PSWindowsUpdate -y
#Add optional updates, get and download and install updates
