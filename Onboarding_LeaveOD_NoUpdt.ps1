...
#Version 2.0.1.3 (No One Drive removal, No Updates, No Scheduled Tasks creation)
...
Function Net-Servs
    ...
    [Array] $Servs = 'DNScache', 'FDResPub', 'SSDPSRV', 'upnphost';
...
#Uncomment lines 256 - 293, 519 in order to activate this section
#Function NoOneDrive
#    {
...
Function SchTask
    {
    #Schedules a maintenance script to run daily at 3AM
    $User = "NT AUTHORITY\SYSTEM"
    $Script = "C:\EWT\Scripts\Maintain.ps1" #edit at scripter discretion, able to schedule any script to run
    $Action = New-ScheduledTaskAction -Execute "powershell.exe" -Argument $Script
    $Trigger = New-ScheduledTaskTrigger -Daily -At 3am
    Register-ScheduledTask -TaskName "Daily Maintenance" -Trigger $Trigger -User $User -Action $Action -RunLevel Highest -Force
    }
#
